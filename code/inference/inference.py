...
# -*- coding: utf-8 -*-
"""
Single-image + text-prompt inference for SAM3-family checkpoints, implemented with
exactly the same working SAM3-family path used in case_study_all_models.py:
...
# ========================= Defaults from your case-study script =========================
DEFAULT_SAM3_CODE_DIR = "/home/Data2/zhuquanhao/US-SAM3/code"
DEFAULT_SAM3_CONFIG = "/home/Data2/zhuquanhao/US-SAM3/configs/internal_datasets/config.yaml"
