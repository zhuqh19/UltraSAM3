...
This script is adapted from eval_agent_all_datasets_v2.py, but removes the
whole-dataset evaluation/COCO metric path. It keeps the working pieces used by
that script:
...
DEFAULT_CONFIG_PATH = "/home/Data2/zhuquanhao/US-SAM3/configs/internal_datasets/config.yaml"
